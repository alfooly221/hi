...
'Accept-Language: fr-FR,fr;q=0.9,ar-AE;q=0.8,ar;q=0.7,en-US;q=0.6,en;q=0.5'
    ]);
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  $res = curl_exec($ch);
...
$header[] = "Accept: */*"; 
$header[] = "Accept-Language: fr-FR,fr;q=0.9,ar-AE;q=0.8,ar;q=0.7,en-US;q=0.6,en;q=0.5"; 
...
function check_ban($gmail){
    ...
    $header[] = "User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36"; 
    $header[] = "content-type: application/x-www-form-urlencoded;charset=UTF-8"; 
    $c = curl_init("https://accounts.google.com/_/signup/accountdetails?hl=ar&_reqid=160012&rt=j"); 
    curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36"); 
    curl_setopt($c, CURLOPT_HTTPHEADER, $header); 
...
function checkGmail($mail){
  ...
  $mail = preg_replace('/@(.*)/', '',$mail);
   $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL,'https://accounts.google.com/_/signup/accountdetails?hl=ar&_reqid=160012&rt=j');
  curl_setopt($ch,CURLOPT_HTTPHEADER, [
    'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36',
'Content-Type: application/x-www-form-urlencoded;charset=UTF-8',
...
'accept-encoding: gzip, deflate, br',
'accept-language: fr-FR,fr;q=0.9,ar-AE;q=0.8,ar;q=0.7,en-US;q=0.6,en;q=0.5',
'client-request-id: 7d91d268660d4db28eb786316246ad0d',
'content-type: application/json; charset=UTF-8',
'cookie: MSCC=93.23.135.60-FR; MUID=0299B217A89D6761380ABC65A9296615; mkt=ar-SA; IgnoreCAW=1; wlidperf=FR=L&ST=1624186909420; SDIDC=CfgpeyxneR!6OBW9fZYVKnR0NQ1WcWP*jwjv4ETqMCg0E9woMELocWqoHS4t36NeKXPOAYsbWSBon2PmTYVQJIUBj2QJu*FG7sh6XVRbzJ4GmNG6auiRKiVb1NBLmJX6lZtxi8WqaVHs*YydMh74lhruEvC3woj8f1wIWmWbu9d6GG7PEJDetm88kxhTMgSJLXihp5H!kr!DucBLIzfXz*pr7ed5Mzzf1JcP6q7Qo8gxTCCBEGnr1kU5xHm01SKyWFXqijCgdoGBTDP0k5csFS5tqJfmLm0jPh7cglnRzz0SRGBP!OLa709eaXcRAAiFzO*oMbIODqxmpJeJRLeNEeh7mCSHbbuTGj7bwenSShwAm8NkmnuWmHOzN142OgfppeSm11369Zuap*Lr*6JUhG1oCiCJYZqLXYNSbW7p34lGBXgyXX9Ub9iWXARCVf9q2OmvSZyXZLizoI1OtE15XoPvujscwWlqqjGd6HK4mSRgGAa*WnhNTH6Kwi4lAT8Kiw$$; uaid=7d91d268660d4db28eb786316246ad0d; MSPRequ=id=N&lt=1625843083&co=1; OParams=11O.DXBVTgtBYnJV23GoXwFsrpisIgr2HPbO6s1GQla*Kfi04c5WU0WGyj!7ypsPrUNsRhJz8*2Sj5vB9!zjS8Jrf2PtziMQQRF!8v1F9nhTn6j6aT3rteJU3omUHWN56f7qAbYG*X!p0MMUSgSxFWRNnsq6K7KtgToIp9G6Ert6e1ufTcnm7JJw9F*YDzOqXRx7a!E2h7AJv7U9!Qyci22ZWLM$; MSPOK=$uuid-06ccac8a-14bc-4d68-9a38-f7280072ed1c',
'hpgact: 0',
'hpgid: 33',
...
'user-agent: Mozilla/5.0 (Linux; Android 10; SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.91 Mobile Safari/537.36'
    ]);
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
  curl_setopt($ch, CURLOPT_ENCODING , "");
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
